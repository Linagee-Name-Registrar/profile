...
<h5 className="m-2 mb-0 text-sm text-gray-700 dark:text-gray-400 ">Attributes</h5>
    ...
    {attributes && attributes.length > 0 && attributes.map((item, index) => ( 
        <div key={index} href="#" className="block m-1 mx-2 p-2 max-w-xs bg-block opacity-50 border border-gray-200 rounded-lg shadow dark:bg-black-800 dark:border-gray-700 ">
