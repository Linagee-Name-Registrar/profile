...
function ImageCardV2({props, key}){
  ...
  leaveTo="translate-y-full opacity-0"
          className={`z-50 bg-gray-400 opacity-70 dark:bg-black dark:opacity-90 m-2 absolute static rounded-md top-0 left-0 right-0 bottom-0 w-auto h-auto items-center justify-center overflow-y-auto`}

          
          >
              {metadata?.md?.attributes ? <AttributeGallery attributes={metadata?.md?.attributes}/> : <h3>Nothing to show ...</h3>}
  </Transition>
        </div>
